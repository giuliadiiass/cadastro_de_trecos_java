package net.giulia.cadastro_de_trecos.crud;

import java.sql.SQLException;
import net.giulia.cadastro_de_trecos.setup.AppSetup;
import net.giulia.cadastro_de_trecos.db.DbConnection;
import static net.giulia.cadastro_de_trecos.setup.AppSetup.*;
import static net.giulia.cadastro_de_trecos.Cadastro_de_trecos.*;
import static net.giulia.cadastro_de_trecos.Tools.showRes;
